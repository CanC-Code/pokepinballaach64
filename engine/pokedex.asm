...
Data_280a6: ; 0x280a6
        db BANK(PokedexInitialGfx)
        dw PokedexInitialGfx
        dw vTilesOB
        dw $6000
        db BANK(PokedexTilemap2)
        dw PokedexTilemap2
        dw $9800
        dw $1000
        db BANK(PokedexTilemap)
        dw PokedexTilemap
        dw vBGWin
        dw $800
        db BANK(PokedexTilemap)
...
Data_280c4: ; 0x280c4
        ...
        dw $9800
        dw $1000
        db BANK(PokedexBGAttributes2)
        dw PokedexBGAttributes2
        dw $9800
        dw $1002
        db BANK(PokedexTilemap)
        dw PokedexTilemap
        ...
        dw $9e00
        dw $800
        db BANK(PokedexBGAttributes)
        dw PokedexBGAttributes
        dw vBGWin
        dw $802
        db BANK(PokedexBGAttributes)
        dw PokedexBGAttributes
