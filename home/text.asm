...
SpecialTextCharPointers:
	dw vTilesSH + 3 * $10 ;start of special font data for LoadSpecialTextChar if DMG
	db BANK(InGameMenuSymbolsGfx)
	dw InGameMenuSymbolsGfx + $40 ;bank of data, then pointer to source. each block is 5 bytes - male

	dw vTilesSH + 4 * $10 ; female
	db BANK(InGameMenuSymbolsGfx)
	dw InGameMenuSymbolsGfx + $30

	dw vTilesSH + 5 * $10 ;apostrophe
	db BANK(Apostrophe_CharacterGfx)
	dw Apostrophe_CharacterGfx

	dw vTilesSH + 3 * $10 ;acute e
	db BANK(E_Acute_CharacterGfx)
	dw E_Acute_CharacterGfx

	dw vTilesSH + 7 * $10 ;asterisk
	db BANK(InGameMenuSymbolsGfx)
	dw InGameMenuSymbolsGfx + $80

	dw vTilesSH + 5 * $10 ;exclaiamation point
	db BANK(Exclamation_Point_CharacterGfx)
	dw Exclamation_Point_CharacterGfx

	dw vTilesSH + 5 * $10 ;little x
	db BANK(InGameMenuSymbolsGfx)
	dw InGameMenuSymbolsGfx + $10

	dw vTilesSH + 6 * $10 ;period
	db BANK(Period_CharacterGfx)
	dw Period_CharacterGfx

	dw vTilesSH + 3 * $10 ;colon
	db BANK(Colon_CharacterGfx)
	dw Colon_CharacterGfx

	dw vTilesSH + 3 * $10 ;start of special font data for LoadSpecialTextChar if DMG
	db BANK(InGameMenuSymbolsGfx)
	dw InGameMenuSymbolsGfx + $40 ;male
	...
	dw vTilesSH + 5 * $10 ;apostrophe
	db BANK(Apostrophe_CharacterGfx_GameboyColor)
	dw Apostrophe_CharacterGfx_GameboyColor

	dw vTilesSH + 3 * $10 ;acute e
	db BANK(E_Acute_CharacterGfx_GameboyColor)
	dw E_Acute_CharacterGfx_GameboyColor

	dw vTilesSH + 7 * $10 ;asterisk
	db BANK(InGameMenuSymbolsGfx)
	dw InGameMenuSymbolsGfx + $80

	dw vTilesSH + 5 * $10 ;exclaimation point
	db BANK(Exclamation_Point_CharacterGfx_GameboyColor)
	dw Exclamation_Point_CharacterGfx_GameboyColor
	...
	dw vTilesSH + 6 * $10 ;period
	db BANK(Period_CharacterGfx_GameboyColor)
	dw Period_CharacterGfx_GameboyColor

	dw vTilesSH + 3 * $10 ;colon
	db BANK(Colon_CharacterGfx_GameboyColor)
	dw Colon_CharacterGfx_GameboyColor
